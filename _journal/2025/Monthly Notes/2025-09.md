...
WHERE type = "daily" AND month = date(2025-09) AND meta(bullet.section).subpath = "New Notes"
```
...
```dataview
TASK
WHERE type = "daily" AND month = date(2025-09)
```
...
let dateFilter = dv.date("2025-09");
